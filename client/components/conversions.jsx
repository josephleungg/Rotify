    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex gap-32">
                <div className="bg-[#95BA84] h-[150px] w-[150px] flex flex-col justify-center items-center rounded-xl hover:scale-95 transition-all cursor-pointer">
                ...
                <div className="bg-[#7B649B] h-[150px] w-[150px] flex flex-col justify-center items-center rounded-xl hover:scale-95 transition-all cursor-pointer">
